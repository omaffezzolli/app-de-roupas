	...
	public static void main(String[] args) {
		...
		while (opcaoSelecionada != 0) {
			...
			case 3: {
				...
				System.out.println("Informe o tamanho da(s) calca(s)(p,m,g ou gg): ");
				loja.tamcalca = leitura.nextLine();
				System.out.println("Informe o tamanho da(s) camisa(s) (p,m,g ou gg): ");
				loja.tamcamisa = leitura.nextLine();
				System.out.println("Informe o tamanho dao(s) casaco(s) (p,m,g ou gg): ");
				loja.tamcasaco = leitura.nextLine();
